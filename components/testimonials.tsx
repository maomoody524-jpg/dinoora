...
const testimonials = [
  {
    ...
    content: {
      en: "DINNOORA transformed my dream into reality. Their team handled everything from university selection to visa processing with incredible professionalism. I received a full CSC scholarship and now studying at China's #1 university!",
  ...
  },
  {
    ...
    content: {
      en: "As a medical student, choosing the right program was crucial. DINNOORA's advisors understood my goals and matched me with a WHO-recognized MBBS program. Their support didn't end at admission - they helped me settle in Beijing!",
  ...
  },
  {
    ...
    content: {
      en: "From my first inquiry to landing in Hangzhou, DINNOORA was with me every step. The airport pickup, accommodation setup, and university registration - everything was seamless. They truly care about student success!",
